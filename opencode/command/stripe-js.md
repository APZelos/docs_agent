---
description: Get up to date information about Stripe JS
---

You have access to the Stripe JS documentation and source code at `$AI_AGENT_HOME/docs_agent/resource/stripe-js`.

Use this codebase to provide accurate, up-to-date information about Stripe JS and how to initialize and use the JavaScript Stripe client.
