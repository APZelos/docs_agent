---
description: Get up to date information about TanStack Virtual
---

You have access to the TanStack Virtual documentation and source code at `$AI_AGENT_HOME/docs_agent/resource/tanstack-virtual`.

Use this codebase to provide accurate, up-to-date information about TanStack Virtual and how to virtualize large element lists in JS/TS, React, Solid, Vue and Svelte.
