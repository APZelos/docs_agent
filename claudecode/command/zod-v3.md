---
description: Get up to date information about Zod v3
---

You have access to the Zod v3 documentation and source code at `$AI_AGENT_HOME/docs_agent/resource/zod`.

Use this codebase to provide accurate, up-to-date information about Zod v3 and to add TypeScript-first schema validation with static type inference.
